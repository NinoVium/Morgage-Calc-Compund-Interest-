var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let div8;
    	let t17;
    	let t18_value = /*formatter*/ ctx[6].format(/*monthlyPayment*/ ctx[5]) + "";
    	let t18;
    	let t19;
    	let div9;
    	let t20;
    	...
    	let div10;
    	let t23;
    	let t24_value = /*formatter*/ ctx[6].format(/*monthlyPayment*/ ctx[5] * /*years*/ ctx[1] * 12) + "";
    	let t24;
    	let mounted;
    	let dispose;
    	...
    	return {
    		c() {
    			main = element("main");
    			div0 = element("div");
    			div0.innerHTML = `<h1>Morgage Calc</h1>`;
    			t1 = space();
    			div1 = element("div");
    			...
    			t24 = text(t24_value);
    			attr(div0, "class", "row");
    			attr(label0, "for", "loanInput");
    			attr(input0, "name", "loanInput");
    			attr(input0, "type", "number");
    			attr(input0, "class", "u-full-width");
    			attr(input0, "min", "1");
    			attr(input0, "placeholder", "Enter loan Amount");
    			attr(div1, "class", "row");
    			attr(label1, "for", "year");
    			attr(input1, "type", "range");
    			attr(input1, "min", "1");
    			attr(input1, "name", "year");
    			attr(input1, "max", "50");
    		...
    		m(target, anchor) {
    			...
    			append(div1, t3);
    			append(div1, input0);
    			set_input_value(input0, /*loan*/ ctx[0]);
    			append(main, t4);
    			append(main, div4);
    			append(div4, div2);
    			append(div2, label1);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(input2, "change", /*input2_change_input_handler*/ ctx[10]),
    					listen(input2, "input", /*input2_change_input_handler*/ ctx[10])
    				];
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*loan*/ 1 && to_number(input0.value) !== /*loan*/ ctx[0]) {
    				set_input_value(input0, /*loan*/ ctx[0]);
    			}
    			...
    			if (dirty & /*monthlyPayment*/ 32 && t18_value !== (t18_value = /*formatter*/ ctx[6].format(/*monthlyPayment*/ ctx[5]) + "")) set_data(t18, t18_value);
    			if (dirty & /*totalPayments*/ 8) set_data(t21, /*totalPayments*/ ctx[3]);
    			if (dirty & /*monthlyPayment, years*/ 34 && t24_value !== (t24_value = /*formatter*/ ctx[6].format(/*monthlyPayment*/ ctx[5] * /*years*/ ctx[1] * 12) + "")) set_data(t24, t24_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*interestRate*/ 16) {
    			$$invalidate(7, intereerer = interestRate / 100 + 1);
    		}
    		...
    		if ($$self.$$.dirty & /*loan, intereerer, years, totalPayments*/ 139) {
    			$$invalidate(5, monthlyPayment = (loan * Math.pow(intereerer, years) / totalPayments).toFixed(2));
    		}
    	};
